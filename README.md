...
**Principal Director, AI Strategy & Enterprise Transformation**

Executive AI strategist bridging technical engineering teams and C-suite leadership, boards,
and regulatory bodies — enterprise AI roadmaps, vendor evaluation, governance frameworks, and
high-ROI deployment across regulated industries. Dual MBA (Columbia; UC Berkeley) and a
computer science degree (UC Davis) underneath the strategy work, not instead of it.

A few of the numbers, plainly stated:

- Architected a municipal multi-agent AI system (AutoGen, MemGPT) that delivered a 23%
  help-desk workload reduction — after two prior enterprise vendors had already failed at it.
- Designed an enterprise RAG knowledge-retrieval pipeline with an 85% decision-accuracy
  improvement over a four-year baseline.
- Diagnosed a clinical ML pipeline's accuracy gap to its real root cause (a sharding scheme,
  not the model) and redesigned it — plus $3M+ in separately identified optimization
  opportunities across the same engagement.
- Directed a ServiceNow AI workflow redesign that drove a 65% increase in first-touch
  resolution and $2M+ in documented labor savings.

Author of 26 books on AI strategy and adoption (Amazon KDP), including the *Stop Learning AI*
...
how I stay able to tell the difference myself, not delegate that judgment to whoever's selling.
